...
CLASS lsc_z05_r_travel IMPLEMENTATION.
  ...
  METHOD save_modified.
    ...
    DATA(model) = NEW /lrn/cl_s4d437_tritem( i_table_name = 'Z05_TRITEM' ).

    LOOP AT delete-item ASSIGNING FIELD-SYMBOL(<item_d>).
      DATA(msg_d) = model->delete_item( EXPORTING i_uuid = <item_d>-ItemUuid ).
  ...
  METHOD map_message.
    DATA(severity) = SWITCH #( i_msg-msgty WHEN 'S' THEN if_abap_behv_message=>severity-success
  ...
  METHOD determineTravelDates.
    ...
    LOOP AT items ASSIGNING FIELD-SYMBOL(<item>).
      ASSIGN travels[ KEY id
                      %tky = link[ KEY id
                                   source-%tky = <item>-%tky ]-target-%tky ] TO FIELD-SYMBOL(<travel>).
...
CLASS lhc_Travel IMPLEMENTATION.
    ...
    LOOP AT travels ASSIGNING FIELD-SYMBOL(<travel>).
      ...
      ELSEIF <travel>-BeginDate < cl_abap_context_info=>get_system_date( ).
        ...
        APPEND VALUE #( %tky = <travel>-%tky
                        %msg = NEW /lrn/cm_s4d437( textid = /lrn/cm_s4d437=>begin_date_past ) ) TO reported-travel.
      ELSE.
        APPEND VALUE #( %tky = <travel>-%tky ) TO failed-travel.
        APPEND VALUE #( %tky = <travel>-%tky
  ...
  METHOD determineStatus.
    ...
    LOOP AT travels ASSIGNING FIELD-SYMBOL(<travel>).
      ...
      <travel>-Status = COND #( WHEN <travel>-Status IS INITIAL THEN 'N' ELSE <travel>-Status ).
