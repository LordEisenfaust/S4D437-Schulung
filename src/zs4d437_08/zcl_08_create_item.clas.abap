CLASS zcl_08_create_item DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_08_create_item IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA travel TYPE TABLE FOR CREATE z08_r_travel.
    DATA items TYPE TABLE FOR CREATE z08_r_travel\_Item.
