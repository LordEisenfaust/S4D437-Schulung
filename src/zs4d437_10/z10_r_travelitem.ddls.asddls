...
define view entity Z10_R_TRAVELITEM
  as select from z10_tritem
  association to parent Z10_R_TRAVEL as _Travel on _Travel.AgencyId = $projection.AgencyId and _Travel.TravelId = $projection.TravelId
  {
